...
public class OneEnemyGenerator : MonoBehaviour
{
    [SerializeField]
    GameObject oneEnemyType;
    ...
    public void AppearItemEnemy()
    {
        ...
        GameObject enemy = Instantiate(oneEnemyType, pos, Quaternion.Euler(0f, randomRotationY, 0f)).gameObject;
        Enemys.Add(enemy);
        elapsedTime = 0f;
    }
}
