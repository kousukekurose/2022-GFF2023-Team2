...
public class TwoEnemyGenerator : MonoBehaviour
{
    [SerializeField]
    GameObject twoEnemyType;
    ...
    public void AppearItemEnemy()
    {
        ...
        GameObject enemy = Instantiate(twoEnemyType, pos, Quaternion.Euler(0f, randomRotationY, 0f)).gameObject;
        Enemys.Add(enemy);
        elapsedTime = 0f;
    }
}
